...
using Expressions.Task3.E3SQueryProvider.Custom;
...
namespace Expressions.Task3.E3SQueryProvider.Test.Ignored
{
    ...
    public class E3SProviderTests
    {
        ...
        private static string ConnectionString = config["ConnectionStrings:connectionString"];
        private static string MasterConnectionString = config["ConnectionStrings:masterConnectionString"];
        ...
        [Fact]
        public void WithCustomProvider()
        {
            ...
            {
                _testOutputHelper.WriteLine($"Product: {product.ProductName}, ProductType: {product.ProductType}, UnitPrice: {product.UnitPrice}");
            }
        }
